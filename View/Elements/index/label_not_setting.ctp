<?php
/**
 * index/label_not_setting template elements
 *
...
?>
<p id="iframe-status-label_<?php echo intval($frameId); ?>">
	...
	<span class="label label-danger iframe-status-4 <?php echo $statusHidden[4]; ?>">
		<?php echo __("差し戻し中"); ?>
	</span>
</p>
