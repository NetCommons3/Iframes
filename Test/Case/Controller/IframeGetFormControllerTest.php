<?php
/**
 * IframeGetFormController Test Case
 *
 ...
 */
class IframeGetFormController extends ControllerTestCase {
 ...
 */
	public function testGetForm() {
		...
		$frameId = 1;
		$this->testAction('/iframes/iframes/iframeForm/' . $frameId . '/', array('method' => 'get'));
