<?php
/**
 * IframeEditControllerError Test Case
 *
 ...
 */
class IframeEditControllerErrorTest extends ControllerTestCase {
 ...
 */
	public function testEditByRequestGet() {
		...
		$this->testAction('/iframes/iframe_edit/edit/1', array('method' => 'get'));
	}
